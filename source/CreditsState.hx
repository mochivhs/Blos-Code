...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		[''],
		["Blos Mod"],
		['kat',		'kat',	"Coding, Music, Art, Animation",				'https://twitter.com/mochisuckslol',	0xFF66410F],
		['Stupid_Bloxxer',		'blox',	"Founder of Blos",					'https://twitter.com/stupid_bloxxer',	0xFF0B5259],
