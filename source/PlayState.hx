...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'blosStage': //Week 1
				var bg:BGSprite = new BGSprite('blosground', -600, -200, 0.9, 0.9);
				add(bg);

			case 'ripBozo': //Week 1
			    var bozo:BGSprite = new BGSprite('ripBozo', -600, -200, 0.8, 0.8);
			    add(bozo);
